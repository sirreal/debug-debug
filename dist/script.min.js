...
! ( function( e ) {
	...
	function( e, n, t ) {
		t( 1 )( 'test' )( 'This should say "Hello World!": %s', '"Hello World!"' );
	},
	function( e, n, t ) {
		( function( r ) {
			function o() {
			...
			( ( n = e.exports = t( 3 ) ).log = function() {
				...
				( n.formatArgs = function( e ) {
					...
					e[ 0 ].replace( /%[a-zA-Z%]/g, function( e ) {
						/**
						 * This is the uglified output
						 * It does not work correctly.
						 *
						 * '%%' !== e && '%c' === e && ( s = ++o );
						 *
						 * The rest of the function body is pre-uglification.
	...
	function( e, n ) {
		...
		( o.nextTick = function( e ) {
			...
			u.push( new p( e, n ) ), 1 !== u.length || l || a( d );
		} ),
	...
	function( e, n, t ) {
			...
			function r() {
				if ( r.enabled ) {
					var e = r,
						o = +new Date(),
						s = o - ( t || o );
					( e.diff = s ), ( e.prev = t ), ( e.curr = o ), ( t = o );
					...
					( i[ 0 ] = i[ 0 ].replace( /%([a-zA-Z%])/g, function( t, r ) {
						...
						if ( 'function' == typeof o ) {
							var s = i[ c ];
							( t = o.call( e, s ) ), i.splice( c, 1 ), c--;
						}
						return t;
					} ) ),
						n.formatArgs.call( e, i ),
						( r.log || n.log || console.log.bind( console ) ).apply( e, i );
				}
			}
			return (
				( r.namespace = e ),
		...
		( ( n = e.exports = r.debug = r.default = r ).coerce = function( e ) {
